...
public class searchingdefinitions {
    ...
    public void the_user_is_on_the_homepage() {
        ...
        searchPage = new Searchingpage(driver, extTest);
    ...
    public void the_user_sets_travellers_and_class(String adults, String children, String infants,
        ...
        searchPage.setTravellersAndClass(a, c, i, travel_class);
    }
    ...
    public void search_results_should_be_displayed() {
        boolean res = searchPage.areResultsDisplayed();
